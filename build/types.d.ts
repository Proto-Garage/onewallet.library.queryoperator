...
export declare type QueryOperator<TValue, TOperator extends keyof Operator> = Pick<Operator<TValue>, TOperator>;
...
export declare type IDArrayQueryOperator = QueryOperator<ID, 'overlap'>;
